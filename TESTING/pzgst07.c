...
int_t pzgst07(trans_t *trans, int_t n, int_t nrhs, SuperMatrix *A, doublecomplex *b, 
	    int_t ldb, doublecomplex *x, int_t ldx, doublecomplex *xact, 
 ...
 *  =======   
 *
 *  pzgst07() tests the error bounds from iterative refinement for the   
